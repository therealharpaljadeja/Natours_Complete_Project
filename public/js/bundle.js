    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _axios.default.post('http://127.0.0.1:8000/api/v1/users/login', {
              email: email,
              password: password
...
var stripe = Stripe('pk_test_oo9uJ0sIW1nh8jLmeskx9SIX00HVT0D6uw');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("http://127.0.0.1:8000/bookings/checkout-session/".concat(tourId));
